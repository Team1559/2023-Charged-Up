...
public class GrabberWrist extends SubsystemBase {
    ...
    public void periodic() {
        //SmartDashboard.putNumber("Grabber Angle",wristMotor.get() * SERVO_RANGE - ZERO_ANGLE);
