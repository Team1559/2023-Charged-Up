...
public class ArmBase extends ArmSegment {
    private static final double[] basePos = { 68, 48, 52, 47, 40, 50, 60, 70, 80, 90 };

    public ArmBase() {
        super("Base", ARM_MOTOR_ID_BASE, BASE_CANCODER_ID, kP_BASE, kI_BASE, kD_BASE, kIZ_BASE,
                INV_GEAR_RATIO_BASE, basePos, BASE_SEGMENT_EFFICIENCY, BASE_SEGMENT_MASS,
                BASE_SEGMENT_LENGTH, BASE_SEGMENT_CENTER_OF_MASS);
    }
}
