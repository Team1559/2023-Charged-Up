...
public class ArmElbow extends ArmSegment {
    ...
    public ArmElbow() {
        super("Elbow", ARM_MOTOR_ID_ELBOW, ELBOW_CANCODER_ID, ELBOW_CC_OFFSET, kP_ELBOW, kI_ELBOW,
                kD_ELBOW, kIZ_ELBOW, INV_ELBOW_GEAR_RATIO, elbowPos, ELBOW_SEGMENT_EFFICIENCY,
